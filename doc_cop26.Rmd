...
![3_2wordcloud](./3_2wordcloud.png)
```{r, fig.align='center', echo= FALSE, fig.show='hold', out.width= '75%'}



knitr::include_graphics("3_2wordcloud.png")
```
To see better: 

![FrequencyTable](./3_1FrequencyTable.html)

```{r, echo = FALSE}
keywords_context <- cop26$Headlines %>% 
      corpus() %>% 
      tokens() %>% 
...
htmlwidgets::saveWidget(keywords_context, "3_3KeywordsInContext.html")
```
...
![4_2SentimentFrequencyPlot](./4_2SentimentFrequencyPlot.png)
![5_1MostFrequentlyOccuringWord](./5_1MostFrequentlyOccuringWord.png)


### Bing et al. visualization

![TimeSeriesofSentiment](./5_2_2TimeSeriesofSentiment.html)
