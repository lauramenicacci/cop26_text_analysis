...
pacman::p_load(tidyverse, rvest, stringr, xml2, quanteda, janitor, tidytext, lubridate, wordcloud, SnowballC, dygraphs, xts, tsbox)
```
<br>
...
# ALSO INCLUDED IN THE "scraping_and_data_cleaning.R" file
