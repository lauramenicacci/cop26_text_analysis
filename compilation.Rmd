...
### Taking a step back - sentiment interactive plots by date

After a first glance of the Bing et al. dictionary classification, it can be worth to see how such a classification of words is plotted over time. 
...
The first one shows the negative/positive ratio over time including non-classified words, while the second one is plotted excluding them, as to get a closer look on the changes of the counts. 

```{r, echo = FALSE, fig.align='center'}
sentiment_timeseries <- dygraph(timeseries, 
                                main = "'The Guardian' headlines' across time (incliuding non-classified words)", 
                                xlab = "Date", 
                                ylab = "Frequency") %>%
...
posnegtimeseries <- dygraph(timeseries2, 
                            main = "'The Guardian' headlines' across time (excliuding non-classified words)", 
                            xlab = "Date", 
                            ylab = "Frequency") %>% 
  dySeries("negatives", label="Negative") %>% 
  dySeries("positives", label="Positive") %>%
