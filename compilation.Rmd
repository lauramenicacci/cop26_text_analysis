...
Applying this dictionary to our dataset resulted in assigning sentiment values to 295 words which are distributed over the examined time period. 
```{r, echo = FALSE}
