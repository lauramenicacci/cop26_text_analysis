...
frequencytable
save_kable(frequencytable, "3_2FrequencyTable.html")
...
keywordcontext
  htmlwidgets::saveWidget(keywordcontext, "3_3KeywordsInContext.html")
```
...
ggsave("4_2SentimentFrequencyPlot.png", width = 5, height = 3)
```
...
ggsave("5_1MostFrequentlyOccuringWord.png", width = 5, height = 3)
```
...
save_html(sentiment_timeseries, "./5_2_2TimeSeriesofSentiment.html", libdir = "lib")
...
save_html(posnegtimeseries, "./5_2_3TimeSeriesofPosNegSentiment.html", libdir = "lib")
```
...
colours <- c( "#b2182b","#d6604d", "#f4a582","#fddbc7","#d1e5f0","#92c5de","#4393c3","#2166ac") #"#2166ac","#4393c3", "#92c5de", "#d1e5f0", "#fddbc7", "#f4a582","#d6604d","#b2182b")
...
htmlwidgets::saveWidget(partial_bundle(scatter_result), "6_2AffineAnalysisC26.html")
...
htmlwidgets::saveWidget(partial_bundle(scatter_result_boris), "TEST26_3AffineAnalysisBoris.html")
...
ggsave("6_1DensityPlots.png", width = 5, height = 3)
